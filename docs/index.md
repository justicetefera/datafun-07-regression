...
| **[Feature](ca://s?q=Explain_housing_features_in_regression)** | **R²** | **RMSE** | **Strength** |
| --- | --- | --- | --- |
...
[⭐ **Live Documentation Site**](https://justicetefera.github.io/datafun-07-regression/)

## Project Documentation Pages (docs/)
Maintained by **Justice Tefera**
